...
SELECT id_funcionario FROM funcionarios ORDER BY id_funcionario;
SELECT id_cliente FROM clientes ORDER BY id_cliente;
SELECT id_produto FROM produtos ORDER BY id_produto;
SELECT id_pedido FROM pedidos ORDER BY id_pedido;
